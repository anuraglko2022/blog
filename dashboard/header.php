    ...
    <nav class="navbar show navbar-vertical h-lg-screen navbar-expand-lg px-0 py-3 navbar-light bg-white border-bottom border-bottom-lg-0 border-end-lg" id="navbarVertical">
        <div class="container-fluid">
            ...
            <a class="navbar-brand py-lg-2 mb-lg-5 px-lg-6 me-0" href="#">
                <img src="logo.png" style="width:200px;height:50px" alt="...">
            </a>
            <!-- User menu (mobile) -->
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="allusers.php">
                            <i class="bi bi-bar-chart"></i> All Users
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">
                            <i class="bi bi-chat"></i> Manage Notice
                            <span class="badge bg-soft-primary text-primary rounded-pill d-inline-flex align-items-center ms-auto">6</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="uploadgallery.php">
                            <i class="bi bi-bookmarks"></i> Upload Gallery
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="managegallery.php">
                            <i class="bi bi-people"></i> Manage Gallery
                        </a>
                    </li>
                    <li class="nav-item">
